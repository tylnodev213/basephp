...
?>
    ...
    <form class="form_container" action="" method="POST" enctype="multipart/form-data">
        <div class="form_box">
            ...
            <div class="row form_input">
                <div class="col-md-2"></div>
                <img src="../public/img/<?php echo !empty($data['avatar']) ? $data['avatar'] : "avatar_default.png" ?>"
                     class="avatar_profile" id="preview">
            ...
            <div class="row form_input">
                ...
                <input type="text" maxlength="100" name="password_verify" class="col-md-4 search_box__form--input pw"
                       value="<?php echo $data['password_verify'] ?? "" ?>">
            </div>
            <div class="row form_input">
                <div class="col-md-2"></div>
                <p id="validate--username" class="validate"
            ...
            <div class="row form_input">
                ...
                <input type="radio" name="role_type" value="1"
                       class="col-md-1 form_input" <?php echo isset($data['role_type']) && $data['role_type'] == 1 ? "checked" : "" ?>>
                <label class="col-md-2 form_input">Super Admin</label>
                <input type="radio" name="role_type" value="2"
                       class="col-md-1 form_input" <?php echo isset($data['role_type']) && $data['role_type'] == 2 ? "checked" : "" ?>>
                <label class="col-md-2 form_input">Admin</label>
            </div>
            <div class="row form_input">
                <div class="col-md-2"></div>
                <p id="validate--username" class="validate"
                   style="color:red; font-size:12px"><?php echo checkSessionMessage('Role') ? getSessionMessage('Role') : "";
                    unsetSessionMessage('Role'); ?></p>
            </div>
        </div>

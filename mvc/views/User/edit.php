        ...
        <form class="form_container" action="" method="POST" enctype="multipart/form-data">
            <div class="form_box">
                ...
                <div class="row form_input">
                    ...
                    <input type="radio" name="status" value="1 " class="col-md-1 form_input" <?php echo $each['status'] == 1 ? 'checked' : ""?>>
                    <label class="col-md-2 form_input">Active</label>
                    <input type="radio" name="status" value="2" class="col-md-1 form_input" <?php echo $each['status'] == 2 ? 'checked' : ""?>>

...
?>
    <div class="flow_url">
        <a href="<?php echo DOMAIN."User/search" ?>">Search </a><i class="arrow right"></i><a> Admin Edit</a>
    </div>
    <form class="form_container" action="" method="POST" enctype="multipart/form-data">
        <div class="form_box">
            ...
            <div class="row form_input">
                ...
                <input type="radio" name="status" value="1 " class="col-md-1 form_input" <?php echo $data['status'] == 1 ? 'checked' : ""?>>
                <label class="col-md-2 form_input">Active</label>
                <input type="radio" name="status" value="2" class="col-md-1 form_input" <?php echo $data['status'] == 2 ? 'checked' : ""?>>
                <label class="col-md-2 form_input">Banned</label>
            </div>
            <div class="row form_input">
                <div class="col-md-2"></div>
                <p id="validate--username" class="validate"
                   style="color:red; font-size:12px"><?php echo checkSessionMessage('Status') ? getSessionMessage('Status') : ""; unsetSessionMessage('Status'); ?></p>
            </div>
        </div>
